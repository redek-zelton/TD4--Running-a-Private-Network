...
### Install Go (Optional, not use for this time)
...
* put the `PrivateFor` to allow all interaction in the private network. But I have a Http 405 Error "Method not Allowed"
```bash
...
# Or
$curl -X POST http://127.0.0.1:9001 --data '{"jsonrpc":"2.0","method":"quorumExtension_extendContract","params":["0x9aff347f193ca4560276c3322193224dcdbbe578","BULeR8JyUWhiuuCMU/HLA0Q5pzkYT+cHII3ZKBey3Bo=","0xed9d02e382b34818e88b88a309c7fe71e65f419d",{"from":"0xca843569e3427144cead5e4d5999a3d0ccf92b8e","value":"0x0","privateFor":["LXPEzIq3GRMReDaKckedWHkuky52yj45yRou3YA6hkA="],"privacyFlag":1}],"id":15}' --header "Content-Type: application/json"
```

* and we can deploy in this port:  9001 (Cannot be deploy due to Http 405Error)
```js
module.exports = {
  networks: {
    development: {
    host: "localhost", //our network is running on localhost
    port: 9001, // port where your blockchain is running
    network_id: "*",
    type: 'quorum',
    gas: 50000000
    }
...
## Conclusion TD
Les configurations des paramètres sont guidées par la documentation de GoQuorum, cela à été facile à configurer. Mais quand on cherche à deployer un Smart Contract dans une blockchaine privée, il y a très peu d'information. Pour le premier Contrat, le deployment est refusé à cause du gaz (pas résolu). Pour le deuxième, à cause du port: les port 9081 et 9001 sont déployées (>I'm check up!), mais ne peut pas être utiliser ! 
